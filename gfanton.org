...
#+BEGIN_SRC emacs-lisp
  (java :variables java-backend 'eclim
                   eclim-eclipse-dirs '(shell-quote-argument "/Applications/Eclipse Java.app/Contents/Eclipse")
                   eclim-executable (shell-quote-argument "/Applications/Eclipse Java.app/Contents/Eclipse/eclim"))
#+END_SRC
