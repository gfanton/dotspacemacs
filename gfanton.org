...
- [[#spacemacs-initialization][SPACEMACS INITIALIZATION]]
  ...
  - [[#startup-page][Startup Page]]
    - [[#banner][banner]]
    - [[#lists][lists]]
    - [[#recent-list-size][recent list size]]
  - [[#themes][Themes]]
  ...
  - [[#leader-keys][Leader Keys]]
    ...
    - [[#mode-leader-key][mode leader key]]
...
- [[#layers-configuration][LAYERS CONFIGURATION]]
  ...
  - [[#layers][Layers]]
    ...
    - [[#-themes][+ themes]]
      - [[#colors][colors]]
      - [[#themes-megapack-disabled][themes-megapack (disabled)]]
    - [[#-tags][+ tags]]
      - [[#cscope][cscope]]
    - [[#-checkers][+ checkers]]
    ...
    - [[#-web-services][+ web-services]]
      - [[#wakatime-disabled][wakatime (disabled)]]
  ...
  - [[#layers-dependencies][Layers Dependencies]]
    - [[#brew][brew]]
    - [[#npm][NPM]]
    - [[#go-1][GO]]
    - [[#rust-1][Rust]]
...
- [[#user-configuration][USER CONFIGURATION]]
  ...
  - [[#user-configuration-1][User Configuration]]
    - [[#-------------------------------4][------------------------------]]
    - [[#xterm][Xterm]]
    - [[#epa][EPA]]
    - [[#keys][keys]]
      ...
      - [[#buffer-kill-current][buffer-kill-current]]
...
#+BEGIN_SRC bash
  ...
  # setting env
  mkdir -p $HOME/rust/src; echo 'export RUST_SRC_PATH=$HOME/rust/src' >> .zshrc
...
#+BEGIN_SRC emacs-lisp
  ...
  (spacemacs/lsp-bind-keys-for-mode 'java-mode)
  (spacemacs/lsp-bind-keys-for-mode 'react-mode)
#+END_SRC

Enable lsp ui with golang flycheck
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Check each time you open a file 
  ;; (add-hook 'lsp-ui-mode-hook 'flycheck-buffer t 'make-it-local)

  (add-hook 'go-mode-hook
            (lambda ()
              (add-hook 'after-save-hook 'flycheck-buffer t 'make-it-local)
              (add-hook 'auto-save-hook 'flycheck-buffer t 'make-it-local))
            t nil)
...
#+BEGIN_SRC emacs-lisp
  (load-file "~/.spacemacs.d/packages/framemove.el")
  (require 'framemove)
